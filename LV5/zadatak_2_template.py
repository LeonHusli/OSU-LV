...
# ucitaj podatke
df = pd.read_csv("LV5 Klasifikacija primjenom logističke regresije. Vrednovanje klasifikacijskih modela-20260330/penguins.csv")
...
df['species'] = df['species'].map(mapping).astype(int) 
...
plt.bar(x - 0.15, counts_train, width= 0.30, label="train")
plt.bar(x + 0.15, counts_test, width= 0.30, label="test")
